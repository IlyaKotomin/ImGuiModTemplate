/*
 * THIS IS Monogame.ImGuiNet CODE, I JUST CAHNGED IT TO WORK WITH DUCK GAME
 */
using System;
...
namespace ModName.Core.ImGuiAdapter;
...
public sealed class ImGuiRenderer
{
    ...
    private readonly Keys[] _allKeys = Enum.GetValues(typeof(Keys)).Cast<Keys>().ToArray();
    ...
    private void UpdateInput()
    {
        ...
        io.AddMouseWheelEvent(0f, (mouse.ScrollWheelValue - _scrollWheelValue) / WheelDelta);
        _scrollWheelValue = mouse.ScrollWheelValue;
        
        foreach (var key in _allKeys)
            if (TryMapKeys(key, out var multiKey)) io.AddKeyEvent(multiKey, keyboard.IsKeyDown(key));
